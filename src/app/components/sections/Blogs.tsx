...
const Blogs = () => {
  return (
    <section className="md:py-24 py-16">
      ...
      <FContainer>
        <SectionTitle>What I've written</SectionTitle>
          ...
          <div className="pb-10 border-b border-b-neutral-700">
            ...
            <div className="mt-6">
              ...
              <p className="text-white-100 mt-2 sm:text-base text-sm leading-6">
                Once you receive a response from OpenAI, you’ll need to parse it
                to extract the summarized content. The response from the chat
                completions function comes in the format of an array where every
                item have a message property with content of the message. The
                code snippet below demonstrates how to extract the first message
                returned by openAI. In the summariser project, we create an API
                route named summariser/route.ts. This route will handle incoming
                POST requests and extract the URL of the article we want to
        ...
        <div className="md:-mt-[150px] lg:-ml-[600px] md:-ml-[460px]">
          <div className="relative h-[520px] md:w-[750px] w-full">
            <BackgroundLines>
