...
const MagicButtonSmall = ({
  ...
  return (
    <a target={target} href={link || "#"}>
      <button
        type="submit"
        className="relative inline-flex h-10 overflow-hidden rounded-[10px] p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50"
      >
