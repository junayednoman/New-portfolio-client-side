const MagicButton = ({
  ...
  return (
    <button className="relative inline-flex h-12 overflow-hidden rounded-[12px] p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
