      ...
      >
        {navItems.map((navItem: any, idx: number) => (
          <Link
            ...
            href={navItem.link}
            className={cn(
              "relative dark:text-neutral-50 items-center flex space-x-1 text-neutral-600 dark:hover:text-neutral-300 hover:text-neutral-500 md:p-0 p-2 px-[9px] sm:rounded-none rounded-[4px] sm:bg-transparent bg-[#353535] sm:hover:text-purple sm:hover:bg-transparent hover:bg-purple/60"
            )}
          >
